...
w = 300
text = "123456789"
font_path = '/content/text_renderer/data/fonts/eng/Hack-Regular.ttf'
font_size = 18
...
#period = 360  # degree to rotate text
max_val = 18
...
# remap text box pnts
dst = cv2.remap(img, img_x, img_y, cv2.INTER_LANCZOS4)

#  text_x text_x + word_width  remap
#  remap  ymin AND ymax
...
img = draw_four_vectors(dst, remaped_text_box_pnts, color=(0, 0, 0))

#cv2_imshow('cv.remap() sin', dst)
cv2_imshow(dst)
cv2.waitKey()
